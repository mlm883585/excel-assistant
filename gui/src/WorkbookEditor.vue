...
<style scoped>
.workbook-panel{display:flex;flex-direction:column;min-width:0;height:100%;background:var(--surface);border:1px solid var(--border);border-radius:12px;overflow:hidden}.workbook-tools{display:flex;align-items:center;gap:10px;padding:10px 12px;flex-wrap:wrap;font-size:12px;border-bottom:1px solid var(--border-soft)}.workbook-tools strong{font-size:14px;margin-right:auto}.save-state{color:var(--ok)}.save-state.unsaved{color:var(--warn-text)}.univer-container{flex:1;min-height:510px;position:relative;isolation:isolate}.formula-errors{padding:8px 16px;max-height:120px;overflow:auto;color:var(--danger)}.workbook-panel :deep(.el-alert){flex-shrink:0;max-height:180px;overflow:auto}
</style>
